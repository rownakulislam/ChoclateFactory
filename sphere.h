...
public:
    ...
    float shininess;
    // ctor/dtor
    Sphere(float radius , int sectorCount , int stackCount, glm::vec3 amb , glm::vec3 diff , glm::vec3 spec ,glm::vec3 emission, float shiny ) : verticesStride(24)
    {
    ...
    void set(float radius, int sectors, int stacks, glm::vec3 amb, glm::vec3 diff, glm::vec3 spec, float shiny)
    {
        ...
        this->emission = glm::vec3(0.0f,0.00f,0.0f);
    }
